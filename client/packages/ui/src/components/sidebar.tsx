...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      {...props}
    >
      <HugeiconsIcon icon={SidebarLeftIcon} style={{ width: "18px", height: "18px", marginTop: "-1px" }} strokeWidth={2} />
...
function SidebarContent({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "no-scrollbar flex min-h-0 flex-1 flex-col gap-0 py-2 px-2 overflow-auto group-data-[collapsible=icon]:overflow-hidden",
        className
      )}
      {...props}
    />
